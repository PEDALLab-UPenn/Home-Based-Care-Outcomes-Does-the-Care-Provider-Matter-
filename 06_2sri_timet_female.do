...
INPUT: 	$createddata/regressiondata_fnl_multi_nomedhh_sibkidsiv_fm.dta

OUTPUT: Main Table 7 Panel B. Female care recipients
...
log using "$log/2sri_main_table7_female.log", replace
...
loc j = `i'	
	estout tsrib`i'_* using "$output/Table 7B.tex", cells(none) ///
