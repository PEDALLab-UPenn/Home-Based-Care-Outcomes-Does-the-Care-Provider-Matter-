...
INPUT: 	$createddata/timep1/regressiondata_fnl_multi_nomedhh_sibkidsiv.dta

OUTPUT: Main Table 8 Panel D. Outcomes measured at t+1
...
log using "$log/2sri_main_table8D_timep1.log", replace
...
loc j = `i'	
	estout tsrib`i'_* using "$output/Table 8D.tex", cells(none) ///
