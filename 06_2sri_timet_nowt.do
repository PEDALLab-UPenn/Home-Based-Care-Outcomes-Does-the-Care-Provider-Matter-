...
INPUT: 	$createddata/regressiondata_fnl_multi_nomedhh_sibkidsiv_nowt.dta

OUTPUT: Main Table 8 Panel C. Unweighted models
...
log using "$log/2sri_main_table8C_unweighted.log", replace
...
loc j = `i'	
	estout tsrib`i'_* using "$output/Table 8C.tex", cells(none) ///
