...
INPUT: 	$createddata/regressiondata_fnl_multi_nomedhh_sibkidsiv_tpcd.dta

OUTPUT: Main Table 8 Panel B. Top coding the number of siblings and children at 90th percentile
...
log using "$log/2sri_main_table8B_topcoding.log", replace
...
loc j = `i'	
	estout tsrib`i'_* using "$output/Table 8B.tex", cells(none) ///
